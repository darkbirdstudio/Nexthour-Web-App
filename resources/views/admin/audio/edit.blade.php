                    ...
                    <div class="row">
                      <div class="col-lg-4 col-md-5 mb-4">
                        ...
                        <div class="thumbnail-img-block">
                          ...
                          <img src="{{url('/images/audio/thumbnails/'.$audio->thumbnail)}}" id="thumbnail" class="img-fluid" alt="">
                        @else
                      ...
                      <div class="col-lg-8 col-md-7 mb-4">
                        ...
                        <div class="poster-img-block">
                          @if(isset($audio->poster) && $audio->poster != NULL)
                            <img src="{{url('/images/audio/posters/'.$audio->poster)}}" id="poster" class="img-fluid" alt="">
                          @else
