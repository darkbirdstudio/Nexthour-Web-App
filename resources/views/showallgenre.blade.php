                ...
                @if(isset($pusheditems))
                  ...
                  <div class="col-lg-2 col-md-3 col-xs-6 col-sm-4">
                    <div class="cus_img">
                      ...
                      <div class="genre-slide-image home-prime-slider protip progress-movie mar-btm-20" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$item->id}}">
                        @if($auth && getSubscription()->getData()->subscribed == true)
